...
public class Main {
    ...
    public static void main(String[] args) {
        try {
            ...
            JOptionPane.showMessageDialog(null, "Este programa le pedira 5 numeros y se los mostrara en el orden inverso", "SISTEMA", JOptionPane.INFORMATION_MESSAGE);
            for (int i = 0; i < numeros.length; i++) {
                numeros[i] = obtenerNumero("Ingrese el #" + (i + 1) + " número: ");
            }
    ...
    private static void mensajeDelPrograma(int [] numeros){
        StringBuilder resultado = new StringBuilder("Los numeros ingresados en orden inverso son: " + "\n");
            // Mostrando desde el final hasta el principio
